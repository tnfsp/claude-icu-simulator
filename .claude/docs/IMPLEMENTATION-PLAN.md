...
- [x] **4.1** 建立 `/api/chat` API Route
- [x] **4.2** Claude API 封裝（`lib/claude.ts`）
- [x] **4.3** 對話輸入元件整合
- [x] **4.4** Streaming 回應實作
- [x] **4.5** 對話歷程 context 管理

### Phase 5: 情境系統 ✅
> 情境載入與 Debrief

- [x] **5.1** 建立首個情境 JSON（Cardiogenic shock）
- [x] **5.2** 建立 `/api/scenario` API Route
- [x] **5.3** 情境載入與初始化邏輯
